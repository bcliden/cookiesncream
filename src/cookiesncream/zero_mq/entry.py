...
from cookiesncream.image.filter import bw_filter
from cookiesncream.zero_mq.config import Config
from cookiesncream.zero_mq.models import ErrorReply, Request, SuccessReply
...
def main() -> None:
    ...
    while True:
        ...
        try:
            ...
            # apply the filter
            image = bw_filter(request.image, request.intensity)
